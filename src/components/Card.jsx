    ...
    return (
        <div className = "card__container">
            <Paper className = 'card' style={{borderRadius:"0px", backgroundColor:'#fafafa'}}>
                ...
                <DragHandleRoundedIcon style = {{fill: 'gray'}}></DragHandleRoundedIcon>
                 <span className = 'card__content__text'>{cardContent}</span>
                <IconButton style = {{marginLeft: 10, padding: 0, backgroundColor: 'transparent'}} onClick = {handleDeleteCard}>
                    <Trash style = {{fill: 'tomato'}}></Trash>
                </IconButton>
                </Typography>
            </Paper>
        </div>
