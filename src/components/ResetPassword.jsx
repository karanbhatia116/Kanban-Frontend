...
function ResetPassword({hasLoggedIn, setHasLoggedIn}) {
    ...
    // state to check if the user has successfully reset password
    ...
    function handlePasswordChange (){
        ...
        fetch('https://kanban-backend-server.herokuapp.com/update_password', {
            method: 'POST',
            headers: {
        ...
        .then(data => {
            ...
            if (data.success === false) {
                ...
                NotificationManager.error("Username is invalid !", 'Error', 3000);
                console.log(data);
            } else {
                //if the credentials are correct then clear the fields and set the state to true
                NotificationManager.success("Password Changed Successfully! Click Here to Go to Login Page. ", 'Success', 3000, ()=>{
    ...
    return (
        ...
        { resetPassword && <Navigate to={`/`} push = {true}></Navigate>} {/* if the user has reset the password then redirect to login page */}
        <Card color="primary" variant="outlined">
            ...
            <Grid container item direction="column" justify="center" alignItems="center" xs={12} style={{ padding: "1em" }}>
                <Button variant="contained" style={{ backgroundColor: "#006C65", color: "#FFFFFF" }} onClick={handlePasswordChange}>
